...
--- Region  : AMEA
--- Purpose : The purpose of this SQL is to extract Actual shipment from EAP and KOP system
-------------------------------------------------------------------------------
select  
...
from
(
	select * from amea.uvw_menat_pathways_kop_actual_shipments
	union
	select * from amea.uvw_menat_pathways_eap_actual_shipments
) as final
;