...
--- Region  : AMEA
--- Purpose : The purpose of this SQL is to extract Shipment data from KOP and EAP system
-------------------------------------------------------------------------------
select
...
from
(
	select * from amea.uvw_menat_pathways_kop_planned_shipments
	union
	select * from amea.uvw_menat_pathways_eap_planned_shipments
) as final
;