...
--- Region  : AMEA
--- Purpose : The purpose of this SQL is to extract shipment orders from EAP and KOP SAP
-------------------------------------------------------------------------------
SELECT 
...
from
(
	select * from amea.uvw_menat_pathways_kop_orders
	union
	select * from amea.uvw_menat_pathways_eap_orders
) as final
;